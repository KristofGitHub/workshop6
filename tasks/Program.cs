// ЗАДАЧА 1. Напишите программу, которая принимает на вход три числа и проверяет, возможен ли треугольник со сторонами такой длины.
...
// ЗАДАЧА 2. Ввывести числа Фибоначчи без использования рекурсии.
int f_prefinal = 0;
int f_final = 1;
...
int size = GetUserInput1("array_size");
int min = GetUserInput("min_value");
int max = GetUserInput("max_value");
